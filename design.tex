...
Five microprocessors were considered for the system, the Arduino nano, Raspberry Pi, Blackfin processor from Analog Devices, and the dsPIC from Microchip, and were judged on six factors
\begin{description}
...
\item[Interface:] How easy it to upload code to the device
\item[Size] How large is the processor
\item[Power Consumption] How much power does it use
\item[Cost] How expensive is the processor
